...
- Commit `.dev-notes/learning/` (including useful `knowledge/`).
...
6. Self-review, then write `learning.md` + seed `journal.md` and `knowledge/knowledge.md`.
...
5. **Record** — append a **dated** `journal.md` entry (concise: covered,
   ...
   [`curate-knowledge`](../curate-knowledge/SKILL.md) (`add-knowledge`). If the
   step introduced a heavily-used construct/command/arg combo, add it to
